                  ...
                  <div className="mt-auto">
                    {format.link ? (
                      <a 
                        ...
                        className={`block text-center w-full py-4 rounded-full font-bold text-lg transition-all ${format.highlight ? 'bg-black text-white hover:bg-zinc-800 active:scale-95' : 'bg-white text-black hover:bg-zinc-200 active:scale-95'}`}
                      >
                        {format.cta}
                      </a>
                    ) : (
